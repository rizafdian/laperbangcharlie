                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- form start -->
                            <form method="POST" action="<?php echo base_url('admin/adminlaper/add_rekap_triwulan'); ?>" enctype="multipart/form-data">
                                <div class="mb-3">
                            ...
                            <?php foreach ($all as $one) : ?>
                                <?php if ($one['periode_triwulan'] == '03') : ?>
                                    <div class="d-flex flex-column justifxy-content-center px-3">
                                        <a class="text-decoration-none" href="<?php echo base_url() ?>admin/adminlaper/view_rekap_tri/<?= $one['id'] ?>">
