...
<div class="modal fade" id="uploadFileModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('admin/admin/uploadPutusan'); ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="uploadFilePP" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('admin/admin/upload_pp'); ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="uploadMH" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('admin/admin/pilih_mh'); ?>" enctype="multipart/form-data">
