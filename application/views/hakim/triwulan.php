        ...
        <div class="d-flex justify-content-center">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <!-- <li>
                        <a class="dropdown-item" href="<?= base_url('hakim/hakim_laper/triwulan'); ?>">All</a>
                    </li> -->
                    <?php foreach ($years as $y) : ?>

                        <li><a class="dropdown-item" href="<?php echo base_url(); ?>hakim/hakim_laper/triwulan_search_year/<?php echo $y['year'];  ?>" value="1"><?php echo $y['year']; ?></a></li>
                        ...
                        <td>
                            <?php foreach ($all as $one) : ?>
                                ...
                                <?php if ($nm['id'] == $one['id_user'] and $one['periode_triwulan'] == '03' and $one['tanggal'] <= '5' and $one['status_laporan'] != 'Revisi') : ?>
                                    <div class="d-flex flex-column justify-content-center">
                                        <a href="<?= base_url('hakim/hakim_laper/view_triwulan/') . $one['id'] ?>" class="text-decoration-none">
