<div class="container">
    <div class="row">
        ...
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link" id="nav-laper-tab" data-toggle="tab" data-target="#nav-laper" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Laporan Perkara</button>
        ...
        <div class="tab-pane fade" id="nav-laper" role="tabpanel" aria-labelledby="nav-laper-tab">Laporan Perkara</div>
