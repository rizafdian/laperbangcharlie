                        ...
                        <tbody>
                            ...
                            <?php foreach ($laporan as $lhs) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <a class="text-decoration-none text-secondary" href="<?php echo base_url() ?>pp/pp_laper/zip_file/<?= $lhs['id'] ?>">
                                    ...
                                    <td class="align-middle text-center">
                                        <?php if ($lhs['status'] == "Belum Validasi") : ?>
                                            <a class="text-decoration-none" href="#" data-bs-toggle="modal" data-bs-target="#validasiModal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo base_url('pp/pp_laper/add_catatan'); ?>">
                        <div class="container">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn text-white bg-primary">Simpan</button>
                </div>
                </form>
            </div>
        </div>
