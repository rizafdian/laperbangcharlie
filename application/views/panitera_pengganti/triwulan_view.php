                        ...
                        <tbody>
                            ...
                            <?php foreach ($laporan as $lhs) : ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <a class="text-decoration-none text-secondary" href="<?php echo base_url() ?>pp/Pp_laper/zip_file_triwulan/<?= $lhs['id_triwulan'] ?>"> <i class="fas fa-download"></i></a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url('pp/Pp_laper/add_catatan_triwulan'); ?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="validasiModal<?php echo $lhs['id_triwulan'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url('pp/Pp_laper/add_validasi_triwulan'); ?>" enctype="multipart/form-data">
