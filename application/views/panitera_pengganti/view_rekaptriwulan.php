    ...
    <div class="row mt-5">
        <div class="col">
            ...
            <?php foreach ($triwulan as $lhs) : ?>
                <!-- button -->
                <a class="btn btn-primary btn-sm mb-3" href="<?php echo base_url() ?>pp/Pp_laper/zip_rekap_triwulan/<?= $lhs['id'] ?>">
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <span class="text-secondary text-xs font-weight-normal">
                                            <?php if ($lhs['lap_pdf'] == null && $lhs['lap_xls'] == null) : ?>
                                                <a href="<?php echo base_url() ?>pp/Pp_laper/file_not_found" class="text-decoration-none text-secondary"><i class="fas fa-file-pdf"></i></a> |
                                                <a href="<?php echo base_url() ?>pp/Pp_laper/file_not_found" class="text-decoration-none text-secondary"><i class="fas fa-file-excel"></i></a>
                                            <?php else : ?>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url('pp/Pp_laper/lap_RekapTriwulan'); ?>" enctype="multipart/form-data">
