    ...
    <div class="col-xl-4 col-md-6">
        <div class="card bg-primary text-white mb-4">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between">
                <a class="small text-white stretched-link"><?php echo $data_harian; ?> Perkara</a>
...
<div class="row">
        <div class="col-xl-6">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body"><canvas id="LaperZona1" width="100%" height="30"></canvas></div>
    ...
    <div class="row">
        <div class="col-xl-6">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body"><canvas id="LaperZona2" width="100%" height="30"></canvas></div>
                <!-- <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div> -->
            </div>
